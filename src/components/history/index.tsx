...
export default function History({
	...
	var {dev} = React.useContext(DeveloperCtx);
	...
	return (
		<div className="w-full pt-2">
			<div className="flex gap-2 items-center">
				...
				{dev=="true"?
					<button
						className="bg-[var(--purple)] text-[color:var(--text-on-color)] hover:bg-[var(--purple-50)] rounded px-2 py-1 text-sm font-bold mt-1"
